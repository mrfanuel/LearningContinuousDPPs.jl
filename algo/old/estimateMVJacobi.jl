...
function estimateMVJacobi(s::Int64,n::Int64,p::Int64,kernel::String,nu::Float64,sigma::Float64,lambda::Float64,epsilon::Float64,it_max::Int64,tol::Float64,n_step_plot::Int64)
    ######################################################################
