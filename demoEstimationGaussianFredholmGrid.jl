...
function demoEstimationGaussianFredholmGrid(s::Int64=10,n::Int64=1000,p::Int64=1000,sigma::Float64=0.05,lambda::Float64=0.1,epsilon::Float64=1e-12,it_max::Int64=10000,tol::Float64=1e-5)
    ...
    if n!== size(FredholmSample,1)
        error("n should be a square")
    end
    ###################################
